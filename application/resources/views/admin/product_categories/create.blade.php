                ...
                <div class="col-sm">
                    <form action="http://localhost/admin/users" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('name'))<br><span style="font-weight:bold; color:red;" class="error">{{ $errors->first('name') }}</span> @endif
                        </div>

                        <div class="form-group">
                            <label for="email">メールアドレス</label>
                            <input type="text" class="form-control " id="email" name="email" value="" placeholder="メールアドレス" autocomplete="email">
                            @if($errors->has('email'))<br><span style="font-weight:bold; color:red;" class="error">{{ $errors->first('email') }}</span> @endif
                        </div>

                        <div class="form-group">
                            <label for="password">パスワード</label>
                            <input type="password" class="form-control " id="password" name="password" placeholder="パスワード" autocomplete="new-password">
                            @if($errors->has('password'))<br><span style="font-weight:bold; color:red;" class="error">{{ $errors->first('password') }}</span> @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @if($errors->has('password_confirmation'))<br><span style="font-weight:bold; color:red;" class="error">{{ $errors->first('password_confirmation') }}</span> @endif
                        </div>
