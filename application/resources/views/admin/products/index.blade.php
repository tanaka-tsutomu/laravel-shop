            ...
            <main role="main" class="col-md-10 ml-sm-auto col-lg-10 px-4">
                                    ...
                                    <div class="input-group-text">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="price_compare"
                                                   id="price-compare-gteq" value="gteq"
                                                   @if ($priceCompare == "gteq") checked
                                                @endif>
                                            <label class="form-check-label" for="price-compare-gteq">以上</label>
                                        </div>
                                        <div class="form-check form-check-inline mr-0">
                                            <input class="form-check-input" type="radio" name="price_compare"
                                                   id="price-compare-lteq" value="lteq"
                                                   @if ($priceCompare == "lteq") checked
                                                @endif>
                        ...
                        <div class="col-md-4 mb-3">
                            <select class="custom-select" name="sort">
                                ...
                                <option value="product-category-asc"
                                        @if ($sort == 'product-category-asc') selected
                                    @endif>並び替え: 商品カテゴリ昇順
                                </option>
                                <option value="product-category-desc"
                                        @if ($sort == 'product-category-desc') selected
                                    @endif>並び替え: 商品カテゴリ降順
                                </option>
                                ...
                                <option value="price-asc"
                                        @if ($sort == 'price-asc') selected
                                    @endif>並び替え: 価格昇順
                                </option>
                                <option value="price-desc"
                                        @if ($sort == 'price-desc') selected
                                    @endif>並び替え: 価格降順
                                </option>
                            </select>
                        </div>
                ...
                <ul class="list-inline pt-3">
                    <li class="list-inline-item">
                        <a href="http://localhost/admin/products/create" class="btn btn-success">新規</a>
                    </li>
                </ul>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td><a href="http://localhost/admin/products/{{$product->id}}">{{$product->name}}</a>
                                </td>
